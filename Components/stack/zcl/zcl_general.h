...
//Added by Yang,  identifying , shine the LED for 5 seconds
#define COMMAND_IDENTIFYING                                    0x10
...
// Added by Yang
typedef void(*zclGCB_SmartGarden_t)(uint8 cmd);
...
typedef struct
{
  ...
  // Added by Yang
  zclGCB_SmartGarden_t            pfnSmartGarden;
...
// Added by Yang
/*
* Send Read Heartbeat Period

* (uint8 srcEP, afAddrType_t * dstAddr, uint16 clusterID, zclReadCmd_t * readCmd, uint8 direction, uint8 disableDefaultRsp, uint8 seqNum)
*/
#define zclGeneral_SendRead_HeartbeatPeriod(a,b,c,d,e) zcl_SendRead((a), (b), ZCL_CLUSTER_ID_GEN_BASIC, (e), ZCL_FRAME_CLIENT_SERVER_DIR, (c), (d))
